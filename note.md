- [ ] build the blog, no XHR request, test cases to verify the guess: no more request will be sent because this is static website and all data are loaded in browser?
